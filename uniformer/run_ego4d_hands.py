...
def get_args():
    ...
    parser.add_argument('--use_contact_time', action='store_true', default=False)
...
def main(args, ds_init):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            multi_task=args.multi_task, use_contact_time=args.use_contact_time,
        )
        ...
        if data_loader_val is not None:
            test_stats = validation_one_epoch(data_loader_val, model, device, multi_task=args.multi_task, use_contact_time=args.use_contact_time)
